...
<<<<<<< HEAD
    dv_metric_actuator_executor_options: 'Options Parameters',
    dv_metric_actuator_parallelism: 'Parallelism',
    dv_metric_actuator_job_name: 'Job Name',
    dv_metric_actuator_yarn_queue: 'Yarn Queue',
...
>>>>>>> upstream/dev
    ...
    dv_metric_error_output_to_datasource_database: 'Error Data Output To Datasource Database',
    dv_metric_job_error_message: 'Keep at least one metric',
    dv_metric_job_comparison_support_one_metric_message: 'Comparison metric only supports one metric',
    ...
    editor_dv_Configuration: 'Configuration',
    editor_dv_Runs: 'Runs',
